...
class ReceiveWorkshopController extends Controller
{
    ...
    /**
     * @Route("/{id}", name="transaction_receive_workshop_show")
     * @Method("GET")
     * @Security("has_role('ROLE_TRANSACTION')")
     */
    ...
    /**
     * @Route("/{id}/edit", name="transaction_receive_workshop_edit")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_TRANSACTION')")
     */
    ...
    /**
     * @Route("/{id}/delete", name="transaction_receive_workshop_delete")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_TRANSACTION')")
     */

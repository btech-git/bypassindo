...
class DeliveryOrderController extends Controller
{
    ...
    /**
     * @Route("/{id}", name="transaction_delivery_order_show")
     * @Method("GET")
     * @Security("has_role('ROLE_TRANSACTION')")
     */
    ...
    /**
     * @Route("/{id}/edit.{_format}", name="transaction_delivery_order_edit")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_TRANSACTION')")
     */
    ...
    /**
     * @Route("/{id}/delete", name="transaction_delivery_order_delete")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_TRANSACTION')")
     */

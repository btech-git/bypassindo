...
class PurchaseWorkshopHeaderController extends Controller
{
    ...
    /**
     * @Route("/{id}", name="transaction_purchase_workshop_header_show")
     * @Method("GET")
     * @Security("has_role('ROLE_TRANSACTION')")
     */
    ...
    /**
     * @Route("/{id}/edit.{_format}", name="transaction_purchase_workshop_header_edit")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_TRANSACTION')")
     */
    ...
    /**
     * @Route("/{id}/delete", name="transaction_purchase_workshop_header_delete")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_TRANSACTION')")
     */

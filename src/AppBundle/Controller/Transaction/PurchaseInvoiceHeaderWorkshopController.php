...
class PurchaseInvoiceHeaderWorkshopController extends Controller
{
     ...
     * @Method("POST")
     * @Security("has_role('ROLE_PURCHASE_INVOICE_HEADER_WORKSHOP_NEW') or has_role('ROLE_PURCHASE_INVOICE_HEADER_WORKSHOP_EDIT') or has_role('ROLE_PURCHASE_INVOICE_HEADER_WORKSHOP_DELETE')")
     */
     ...
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_PURCHASE_INVOICE_HEADER_WORKSHOP_NEW')")
     */
     ...
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_PURCHASE_INVOICE_HEADER_WORKSHOP_EDIT')")
     */
     ...
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_PURCHASE_INVOICE_HEADER_WORKSHOP_DELETE')")
     */

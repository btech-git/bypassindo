...
use AppBundle\Grid\Report\VehicleModelSaleInvoiceGridType;

/**
 * @Route("/report/vehicle_model_sale_invoice")
 */
class VehicleModelSaleInvoiceController extends Controller
{
    /**
     * @Route("/grid", name="report_vehicle_model_sale_invoice_grid", condition="request.isXmlHttpRequest()")
     * @Method("POST")
    ...
    public function gridAction(Request $request)
    {
        ...
        return $this->render('report/vehicle_model_sale_invoice/grid.html.twig', array(
            'grid' => $grid->createView(),
        ));
    }

    /**
     * @Route("/", name="report_vehicle_model_sale_invoice_index")
     * @Method("GET")
     * @Security("has_role('ROLE_ACCOUNTING_HEAD') or has_role('ROLE_OPERATIONAL_HEAD') or has_role('ROLE_SALES_MANAGER')")
     */
    public function indexAction()
    {
        return $this->render('report/vehicle_model_sale_invoice/index.html.twig');
    }

    /**
     * @Route("/export", name="report_vehicle_model_sale_invoice_export")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_ACCOUNTING_HEAD') or has_role('ROLE_OPERATIONAL_HEAD') or has_role('ROLE_SALES_MANAGER')")
     */
